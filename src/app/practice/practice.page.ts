...
export class PracticePage implements OnInit {
  ...
  ngOnInit() {
    // this.practice=[
    //   {name:'Alok',village:'Parikansari',po:'Ankulachati',via:'Balugaon',dist:'Khurda',image:'/assets/image/alok.jpg'},
    //   {name:'Papu',village:'Parikansari',po:'Ankulachati',via:'Balugaon',dist:'Khurda',image:'/assets/image/papu.jpg'},
    //   {name:'Utsah',village:'kosodi',po:'ankulachati',via:'Balugaon',dist:'khurda',image:'/assets/image/utsah.jpg'},
    // ];
    this.createForm();
    this.list = [
      {
